...
export function Subscribe<T> (selector?: any, comparator?: Comparator): PropertyDecorator {
    return function decorate (target: any, key: string): void {
        const bindingKey = selector.__propertyPath ? selector.__propertyPath : selector;
        let valueKey: string;
        ...
        Object.defineProperty(target, observableKey, {
            get: function () {
                ...
                const observable = NgRedux.instance.select(bindingKey, comparator);
        ...
        const ngDestroy = target.ngOnDestroy;
